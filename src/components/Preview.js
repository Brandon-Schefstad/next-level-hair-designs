...
import regsmallplatts from '../images/regsmallplatts.png';
...
const Preview = ({ title }) => {
	...
	switch (title) {
		case 'Pricing':
			...
			alt =
				'Woman with black and blue brais facing away from the camera.';
			break;
		...
		case 'Two-Feedins':
			...
			alt =
				'Young girl smiling with two long braids going down either side.';
			break;
	}
